 ...
 *    WP Admin > Appearance > Widgets > DTRT Weather
 *
...
<p>
  ...
  <span id="<?php echo $this->get_field_name('number'); ?>-tip" class="wpdtrt-weather-tip">Minimum: 1 | Maximum: <?php echo count($wpdtrt_weather_data); ?></span>
</p>
