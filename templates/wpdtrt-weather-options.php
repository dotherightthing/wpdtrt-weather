...
<div class="wrap">
  ...
  <h1><?php esc_attr_e( 'DTRT Weather', 'wp_admin_style' ); ?>: Placeholder blocks</h1>
    ...
    <div id="post-body" class="metabox-holder columns-2">
      ...
      <div id="post-body-content">
        ...
        <div class="meta-box-sortables ui-sortable">
           ...
           * then $wpdtrt_weather_datatype will be set to the default of ""
           * The user must make a selection so that we know which page to query,
           * so we show the selection box first.
           */
          if ( !isset( $wpdtrt_weather_datatype ) || ( $wpdtrt_weather_datatype === '') ) :
          ?>
            ...
            <div class="inside">
              ...
              <form name="wpdtrt_weather_data_form" method="post" action="">
                ...
                <table class="form-table">
                  <tr>
                    <th>
                      <label for="wpdtrt_weather_datatype">Please select a block type:</label>
                    </th>
                    <td>
                      <select name="wpdtrt_weather_datatype" id="wpdtrt_weather_datatype">
           ...
           * then $wpdtrt_weather_data will contain the body of the resulting JSON.
           */
          ...
          <div class="postbox">
            ...
            <div class="inside">
              ...
              <p>This data set contains <?php echo count( $wpdtrt_weather_data ); ?> blocks.</p>

              <p>The first 6 are displayed below:</p>

              <div class="wpdtrt-weather-blocks">
                <ul>
                ...
                <?php
                  ...
                  foreach( $wpdtrt_weather_data as $key => $val ) {
                    echo "<li>" . wpdtrt_weather_html_image( $key ) . "</li>\r\n";
          ...
          <div class="postbox">
            ...
            <div class="inside">
              ...
              <div class="wpdtrt-weather-data"><pre><code><?php echo "{\r\n";

                  $count = 0;
                  $max_length = 6;

                  foreach( $wpdtrt_weather_data as $key => $val ) {
                    var_dump( $wpdtrt_weather_data[$key] );
            ...
            <div class="inside">
              ...
              <form name="wpdtrt_weather_data_form" method="post" action="">
                ...
                <p>
                  ...
                  <select name="wpdtrt_weather_datatype" id="wpdtrt_weather_datatype">
                    <option value="">None</option>
                    <option value="photos" <?php selected( $wpdtrt_weather_datatype, "photos" ); ?>>Coloured blocks</option>
                    <option value="users" <?php selected( $wpdtrt_weather_datatype, "users" ); ?>>Maps</option>
                  </select>
                </p>
                <p>
