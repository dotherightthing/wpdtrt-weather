...
if ( !class_exists( 'WPDTRT_Weather_Widget' ) ) {
   ...
   */
  class WPDTRT_Weather_Widget extends WP_Widget {

    function __construct() {
      // Instantiate the parent object
      parent::__construct( false, 'DTRT Weather Widget' );
    }
     ...
     * This function's variables will be available to this template.
     */
      require(WPDTRT_WEATHER_PATH . 'templates/wpdtrt-weather-widget.php');
    }
  }

}

if ( !function_exists( 'wpdtrt_weather_register_widgets' ) ) {
  ...
  function wpdtrt_weather_register_widgets() {
    register_widget( 'WPDTRT_Weather_Widget' );
  }

  add_action( 'widgets_init', 'wpdtrt_weather_register_widgets' );
